...
public class ReaderController {
    ...
    @Autowired
    private StringToUTF8 stringToUTF8;
    ...
    public String readerInfoAddDo(String name, String sex, String birth, String address, String phone, String password, RedirectAttributes redirectAttributes) throws UnsupportedEncodingException {
        ReaderInfo readerInfo = getReaderInfo(0, name, sex, birth, address, phone);
        readerInfo = stringToUTF8.transferReaderToUTF8(readerInfo);
    ...
    public String readerInfoEditDoReader(HttpServletRequest request, String name, String sex, String birth, String address, String phone, RedirectAttributes redirectAttributes) throws UnsupportedEncodingException {
        ReaderCard readerCard = (ReaderCard) request.getSession().getAttribute("readercard");
